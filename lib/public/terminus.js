Terminus = {
  ...
  Driver: {
    ...
    _dispatchRequest: function(element) {
      if (element.href) return this.visit(element.href);
      else return this._ancestor(element, 'form').submit();
    },
