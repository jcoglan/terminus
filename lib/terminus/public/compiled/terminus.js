...
Terminus = {
  ...
  connect: function(endpoint) {
    ...
    var client = this._bayeux = new Faye.Client(endpoint),
        self   = this;
    ...
    this.getId(function(id) {
      var subscription = this._bayeux.subscribe('/terminus/clients/' + id, this.handleMessage, this);
  ...
  getId: function(callback, context) {
    ...
    if (opener && opener.Terminus) {
      ...
      parent.JS.require('Terminus', function() {
  ...
  setupSocket: function() {
    ...
    this._bayeux.subscribe('/terminus/sockets/' + this._id, function(message) {
