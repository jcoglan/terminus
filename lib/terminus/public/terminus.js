Terminus = {
  ...
  connect: function(endpoint) {
    ...
    var bayeux = this._bayeux = new Faye.Client(endpoint),
        self   = this;
    ...
    this.getId(function(id) {
      ...
      sub.callback(this.ping, this);
      sub.callback(function() {
        console.log('[SUBSCRIBE]', bayeux.getClientId(), window.location.pathname, '/terminus/clients/' + id);
      }, this);
    }, this);
  },
  ...
  openSocket: function(endpoint) {
    console.log('[SOCKET]', this._id, endpoint);
