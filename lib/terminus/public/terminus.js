Terminus = {
  ...
  connect: function(endpoint) {
    ...
    this.getId(function(id) {
      var subscription = this._client.subscribe('/terminus/clients/' + id, function(message) {
      ...
      subscription.callback(function() {
        console.log('[SUBSCRIBE]', client.getClientId(), window.location.pathname, '/terminus/clients/' + id);
      }, this);
    }, this);
  },
  ...
  ping: function() {
    ...
    this.browserDetails(function(details) {
      this._client.publish('/terminus/ping', details);
      var self = this;
